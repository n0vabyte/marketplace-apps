...
if [[ -n "${DISCOURSE_NOTIFICATION_EMAIL}" ]]; then 
	UDF_VARS["DISCOURSE_NOTIFICATION_EMAIL"]="${DISCOURSE_NOTIFICATION_EMAIL}"
else 
	UDF_VARS["DISCOURSE_NOTIFICATION_EMAIL"]="noreply@${DEFAULT_DNS}"
fi
